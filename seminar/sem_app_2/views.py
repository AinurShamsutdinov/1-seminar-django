...
from sem_app_2.models import Author, Article, Commentary, Order
...
def get_authors(request):
    ...
    return render(request, '/Users/ainurshamsutdinov/Projects/geekbrains/django/1-seminar-django/seminar/sem_app_2/templates/sem_app_2/authors.html', context=context)
...
def get_articles(request, author_id):
    ...
    return render(request, '/Users/ainurshamsutdinov/Projects/geekbrains/django/1-seminar-django/seminar/sem_app_2/templates/sem_app_2/articles.html', context=context)
...
def get_article(request, article_id):
    ...
    return render(request, '/Users/ainurshamsutdinov/Projects/geekbrains/django/1-seminar-django/seminar/sem_app_2/templates/sem_app_2/article.html', context=context)

def get_orders(request):
    context = dict()
    context['text'] = 'All orders:'
    context['orders'] = Order.objects.all()
    return render(request, '/Users/ainurshamsutdinov/Projects/geekbrains/django/1-seminar-django/seminar/sem_app_2/templates/sem_app_2/orders.html', context=context)
...
def get_client_items(request, client_id):
    ...
    for order in orders.all():
        ...
        if delta < datetime.timedelta(days=7):
            ...
            items_7.append(items)
        elif delta < datetime.timedelta(days=30):
            items = order.items.all()
            items_30.append(items)
        elif delta < datetime.timedelta(days=365):
            items = order.items.all()
            items_365.append(items)
    context['items_7'] = items_7
    context['items_30'] = items_30
    context['items_365'] = items_365
    return render(request, '/Users/ainurshamsutdinov/Projects/geekbrains/django/1-seminar-django/seminar/sem_app_2/templates/sem_app_2/client.html', context=context)
